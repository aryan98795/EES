...
export default function Signup({ darkMode }) {
    ...
    return (
        <div className={`min-h-[calc(100vh-80px)] flex items-center justify-center transition-all duration-500 px-6 ${darkMode ? "bg-[#0f172a]" : "bg-[#f1f9ff]"}`}>
            <div className={`w-full max-w-md p-8 rounded-3xl border shadow-2xl transition-all animate-reveal ${darkMode ? "bg-[#1e293b] border-slate-700 shadow-black/20" : "bg-white border-slate-200 shadow-blue-500/10"}`}>
